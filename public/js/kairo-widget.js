                 ...
                 <div class="kairo-chatbot-container" id="kairoChatbotContainer">
                     <div class="kairo-chatbot-header">
                         <div class="kairo-bot-avatar">
                             <img src="http://127.0.0.1:8016/images/kairo.jpg" alt="Kairo IA Avatar" class="kairo-bot-avatar-image">
                         </div>
         ...
         class KairoWidget {
             ...
             initializeMessages() {
                 ...
                 if (savedMessages) {
                     ...
                     messages.forEach(msg => this.displayMessage(msg.content, msg.role));
                 }
             }
